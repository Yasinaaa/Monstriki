package ru.android.monstrici.monstrici.presentation.presenter.main.teacher;
 ...
 */
@InjectViewState
public class MainTeacherMenuPresenter extends BasePresenter<IMainTeacherMenu> {
    @Inject
    ...
    private void getForm(){
        mRepository.getUsers(new IDataCallback<User>(){
            ...
            @Override
            public void onReceiveDataSuccess(Response<User> response) {
                getViewState().onFormGet(response.getBodyList());
            }
